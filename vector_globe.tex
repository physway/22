...
\begin{document}
\begin{asy}
    // Настраиваем вывод в прозрачный PNG высокого разрешения
    settings.outformat = "png"; 
    settings.render = 8;        // Максимальное сглаживание и качество БЕЗ артефактов
    settings.prc = false;
    
    // Включаем честную альфа-прозрачность для 3D-сцены в OpenGL
