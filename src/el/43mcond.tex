...
В магнитном поле с индукцией~$\vec B$ поступательно движется провод длиной~$l$ со скоростью~$\vec v$ (причем $\vec v\perp l$), при этом вектор~$\vec B$ образует угол~$\alpha$ с перпендикуляром~П к плоскости движения. Формула~\eqref{e39} дает ЭДС индукции в этом проводе: $\mathscr E_i=Bvl\cos\alpha$. 
