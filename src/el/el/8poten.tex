...
Случай заряда в однородном электрическом поле напоминает ситуацию с телом, поднятым над поверхностью планеты. Как известно, потенциальная энергия тела, обусловленная притяжением тела и планеты, равна~$E_\text{п}=mgh$. Таким образом, в формуле~\eqref{e30} заряд~$q$ является аналогом массы~$m$, а напряженность~$E$ является аналогом ускорения свободного падения~$g$. 
...
В диэлектрике формула~\eqref{e31} приобретает вид: $\varphi=k\dfrac{q_\text{источника}\strut}{\varepsilon r\strut}$.
