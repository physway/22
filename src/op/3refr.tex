...
% Если луч падает перпендикулярно поверхности раздела сред, то, как можно убедиться по формуле~\eqref{e40}, во второй среде луч сохранит свое направление (т.\,е. преломления луча не будет).  
