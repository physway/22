...
\end{law}
%
Удар шаров на рис.\,\ref{fig:p55} быстрый, поэтому для них закон сохранения импульса с учетом формулы~\eqref{e17} дает уравнения с составляющими импульса по горизонтали и по вертикали соответственно: $p^{\vphantom{'}}_\text{1}=p'_{2}$, $p^{\vphantom{'}}_\text{2}=p'_{1}$.
