...
На диаграмме~$x(t)$ (рис.\,\ref{fig:p60}, справа) сплошной линией показан график изменения координаты тела в рассмотренном промежутке времени; штриховая линия описывает зависимость~$x(t)$ при б\'ольших значениях~$t$. На этом графике отмечен момент времени~$T$, при котором тело возвращается в начальное положение: \emph{за время~$T$ (период) тело проходит путь в четыре}~$x_\text{max}$ \emph{(четыре амплитуды)}.
